...
void UCIApp::mainLoop() {
  while(true) {
    ...
    else if(command == "uci") respondUCI();
    else if(command == "isready") respondReady();
    else if(command == "debug") setDebugMode(args);
    else if(command == "setoption") setOption(args);
    else if(command == "position") setPosition(args);
    else if(command == "go") startCalculation(args);
    else if(command == "stop") stopCalculation();
